...
export interface SignInCardProps {
  ...
  /** Error message to show above the form, if any. */
  error?: string | null;
  /** Route to the sign-up page. */
  signUpHref?: string;
  /** Whether a submission is currently in flight (controlled from outside). */
  isLoading?: boolean;
}
          ...
          <div className="relative group">
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  Sign in to continue to Reviews Admin
                </motion.p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  Нет аккаунта?{" "}
                  <Link to={signUpHref} className="relative inline-block group/signup">
